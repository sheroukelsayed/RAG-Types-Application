...
st.image("carechat.png", width=150)  # Replace with your logo image URL
...
# Initialize session state variable for question input
if "question_input" not in st.session_state:
    st.session_state.question_input = ""  # Initialize only if not already set
